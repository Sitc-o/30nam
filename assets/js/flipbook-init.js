document.addEventListener('DOMContentLoaded', function () {
    ...
    if (flipbookEl && PageFlipClass) {
        ...
        const milestones = [
            ...
            { year: "Tháng 8 năm 1998", milestone: "Xây dựng hạ tầng", desc: "Tháng 8 năm 1998, Chi bộ Xuất nhập khẩu đầu tiên được thành lập.", img: "assets/images/2 - Sự kiện thứ 2 - Đại hội Chi bộ Trung tâm XNK lần thứ nhất.jpg", caption: "Đại hội chi bộ trung tâm xuất nhập khẩu lần thứ nhất năm 2002" },
            ...
            { year: "8.	Tháng 12 năm 2006", milestone: "Triệu khách hàng", desc: "8.	Tháng 12 năm 2006, Hoàn thành Dự án lắp đặt hệ thống thiết bị mạng, hệ thống quản lý tòa nhà Khu Hội Nghị Quốc gia.", img: "assets/images/8- Đc Nguyễn Mạnh Hùng, Lê Đăng Dũng Nguyên Tổng Giám đốc tậ đoàn kiểm tra, chỉ đạo tại công trình TTHN Quốc gia.jpg", caption: "Đồng chí thiếu tướng Nguyễn Mạnh Hùng - Nguyên tổng giám đốc tập đoàn đến kiểm tra và chỉ đạo lắp đặt hệ thống điều khiển tòa nhà tại Trung tâm hội nghị Quốc gia" },
