document.addEventListener('DOMContentLoaded', function () {
    ...
    if (flipbookEl && PageFlipClass) {
        ...
        const milestones = [
            ...
            { year: "Ngày 01 tháng 11 năm 2008", milestone: "Cải tổ mô hình", desc: "11. Ngày 01 tháng 11 năm 2008, Đại hội Đảng bộ Công ty Lần thứ nhất nhiệm kỳ (2008-2010).", img: "assets/images/11. Đc Trần Văn Đải nguyên Chủ nhiệm Chính trị Tập đoàn Chụp ảnh cùng BCH Đảng bộ Công ty lần thứ nhất .jpg", caption: "Ban chấp hành Đảng ủy nhiệm kỳ lần thứ nhất" },
